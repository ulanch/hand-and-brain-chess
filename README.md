...
**Progress Summary**: This project is under active development and not yet ready for production use. Expect breaking changes and missing features while the core gameplay is being built.

## Tech Stack
- **Language(s)**: TypeScript
- **Frameworks / Libraries**: React, Vite, Tailwind CSS
- **Tools / Services**: Node.js, pnpm
...
## To-Do / Roadmap
- [ ] Implement core game logic for piece movement.
- [ ] Add room creation and joining functionality.
- [ ] Set up basic UI for the chessboard and player interactions.

## Known Issues
- The project is a work in progress and not yet playable.
